...
export class AdminController {
  ...
  // suspicious � without loading full message bodies.
  ...
  // --- User chat (by userId) -------------------------------------------------
  // Kept for backward compat � frontend now uses /chat/messages?userId=
